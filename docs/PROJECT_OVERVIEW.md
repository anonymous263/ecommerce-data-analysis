# Project Overview — WooCommerce + POD + GA4

*The working reference for this project: phased plan, roadmap, source-of-truth rules, and privacy constraints. The [README](../README.md) is the short portfolio-facing version and covers only what is built today.*
...
See [docs/ROADMAP.md](ROADMAP.md) for detail.
...
See [docs/DATA_AUDIT.md](DATA_AUDIT.md) for the PII inventory.
...
**Design & specs**
- [docs/PROJECT_PLAN.md](PROJECT_PLAN.md) — scope, site config, phased plan
- [docs/DATA_MODEL.md](DATA_MODEL.md) — schemas, grains, profit formula
- [docs/PIPELINE_DESIGN.md](PIPELINE_DESIGN.md) — EL design + dbt layout
- [docs/METRICS_DEFINITION.md](METRICS_DEFINITION.md) — metric and DAX definitions
- [docs/METRIC_CHANGES.md](METRIC_CHANGES.md) — versioned metric decisions and why they changed
- [docs/DASHBOARD_SPEC.md](DASHBOARD_SPEC.md) — pages + data-quality gating
- [docs/ROADMAP.md](ROADMAP.md)

**Audits & gates**
- [docs/WOO_PAYLOAD_AUDIT.md](WOO_PAYLOAD_AUDIT.md) — **Phase 1 gate** (locks variant/payment-fee parsers, refund grain)
- [docs/GA4_BIGQUERY_AUDIT.md](GA4_BIGQUERY_AUDIT.md) — **Phase 6 gate** (attribution match rate)
- [docs/DATA_AUDIT.md](DATA_AUDIT.md) — PII inventory
...
- [docs/learning/](learning/) — Vietnamese-language write-ups explaining each layer of the build
